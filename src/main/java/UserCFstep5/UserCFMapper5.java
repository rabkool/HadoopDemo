...
public class UserCFMapper5 extends Mapper<LongWritable, Text, Text, Text> {
	...
	protected void setup(Context context) throws IOException, InterruptedException {
		...
		try {
			...
			FileSystem fs = FileSystem.get(URI.create(UserCFMR5.hdfs + UserCFMR5.cache), context.getConfiguration());

			FSDataInputStream in = fs.open(new Path(UserCFMR5.hdfs + UserCFMR5.cache));
