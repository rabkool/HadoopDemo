...
public class ItemCFMapper4 extends Mapper<LongWritable, Text, Text, Text> {
	...
	protected void setup(Context context) throws IOException, InterruptedException {
		...
		try {
			...
			FileSystem fs = FileSystem.get(URI.create(ItemCFMR4.hdfs + ItemCFMR4.cache), context.getConfiguration());
			FSDataInputStream in = fs.open(new Path(ItemCFMR4.hdfs + ItemCFMR4.cache));
