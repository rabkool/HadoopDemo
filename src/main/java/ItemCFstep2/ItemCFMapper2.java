...
public class ItemCFMapper2 extends Mapper<LongWritable, Text, Text, Text> {
	...
	protected void setup(Context context) throws IOException, InterruptedException {
		...
		try {
			...
			FileSystem fs = FileSystem.get(URI.create(ItemCFMR2.hdfs + ItemCFMR2.cache), context.getConfiguration());

			FSDataInputStream in = fs.open(new Path(ItemCFMR2.hdfs + ItemCFMR2.cache));
