...
public class ItemCFMR3 {
	...
	public int run() {
		...
		try {
			...
			// 創建一個job實列
			Job job = Job.getInstance(conf, "ItemCFMR2step3");
			// 設置job的主類
			job.setJarByClass(ItemCFMR3.class);
			
			// 設置job的mapper類的reducer類
			job.setMapperClass(ItemCFMapper3.class);
			job.setReducerClass(ItemCFReducer3.class);
